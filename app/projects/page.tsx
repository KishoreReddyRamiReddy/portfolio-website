...
export default function Projects() {
  ...
  const projects = [
    {
      id: 1,
      title: "Automated Apache Cloud Stack Setup On Ubuntu",
      description: "Automated network configurations, package management, system dependencie, reducing manual intervention ",
      technologies: ["Ubuntu", "Shell Scripting", "Apache CloudStack"],
      type: "Cloud Computing",
      color: "bg-black",
      github: "https://github.com/KishoreReddyRamiReddy/Automated-Apache-Cloud-Stack-Setup-on-Ubuntu",
      image: "/images/projects/rentopia.jpg"
    },
    {
      id: 2,
      title: "Algorithm Simulator",
      description: "Designed to foster a deeper comprehension of fundamental data structures and algorithmic principles by means of visual representation and user engagement.",
      technologies: ["C++", "DSA"],
      type: "DSA",
      color: "bg-black",
      github: "https://github.com/KishoreReddyRamiReddy/Algorithm-Simulator-",
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 py-12 md:py-16">
        ...
        <p className="text-lg text-black font-bold mb-6 animate-[fadeIn_0.7s_ease-in]">
          Explore my Projects of Full-Stack and Cloud Computing.
        </p>
