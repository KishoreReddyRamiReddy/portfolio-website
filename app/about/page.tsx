        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 animate-[fadeIn_0.8s_ease-in]">
          ...
          >
            <div className="flex flex-col items-center">
              ...
              <h3 className="mt-4 font-medium text-lg">Ramireddy Kishore Reddy</h3>
          ...
          >
            <div className="space-y-3 text-black">
              <div className="border-l-4 border-blue-500 pl-3">
                <h4 className="font-medium">Automatic apache cloud stack setup on ubuntu.</h4>
                <p className="text-sm text-gray-600">Shell script, Apache Cloudstack, Ubuntu</p>
              </div>
          ...
          >
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 bg-gray-100 p-3 rounded">
                <img src="/logos/gfgf.jpg" alt="Udemy" className="h-8" />
                <div>
                  <div className=" text-black">
