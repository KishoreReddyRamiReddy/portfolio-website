...
export default function Resume() {
  ...
  const education: Education[] = [
    ...
    },
    {
      ...
      grade: "Percentage: 70.02",
      logo: "/logos/narayana.jpg"  // Add your Narayana logo here
    },
    {
      ...
      location: "Kadapa, Andhra Pradesh",
      grade: "CGPA: 10",
      logo: "/logos/srischool.avif"  // Add your Narayana logo here
    }
  ];
  ...
  const trainings: Training[] = [
    {
      ...
      logo: "/logos/gfgf.jpg"  // Add your GeeksForGeeks logo here
    }
  ];
